...
export const COMPETENCE_DATA = [
  {
    ...
    tasks: [
      {
        title:
          "Tunnistan terveyttä ja hyvinvointia edistäviä ja haittaavia tekijöitä.",
      },
      {
      ...
      {
        title:
          "Pidän huolta omasta fyysisestä, psyykkisestä ja sosiaalisesta hyvinvoinnistani.",
      },
      {
        title:
          "Ymmärrän opiskelun, levon ja vapaa-ajan vuorottelun merkityksen hyvinvoinnille.",
      },
      {
      ...
      {
        title:
          "Osallistun omaa hyvinvointia edistäviin liikunta- ja kulttuurimuotoihin.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Opiskelija osaa käyttää digitaalisia palveluita osana oppimista ja ongelmanratkaisua. Opiskelija osaa toimia vastuullisesti sosiaalisessa mediassa sekä käyttää digitaalisia palveluita asioidessaan viranomaisten ja muiden sähköisiä asiointia edellyttävien palveluntarjoajien kanssa.",
    tasks: [
      {
  ...
  },
  {
    ...
    tasks: [
      {
        title:
          "Pohdin kestävän tulevaisuuden periaatteiden toteutumista omassa ja yhteisöni toiminnassa.",
      },
      {
      ...
      {
        title:
          "Ymmärrän, millaisia vaikutuksia omalla ja muiden toiminnalla on.",
      },
      {
        title:
          "Kannustan muita toimimaan kestävän tulevaisuuden periaatteiden mukaan.",
      },
    ],
  },
  {
...

  {
    ...
    tasks: [
      ...
      {
        title:
          "Tutustun yhteiskunnan toimintaan ja vaikuttamisen eri tapoihin.",
      },
    ],
  },
  {
    ...
    tasks: [
      ...
      {
        title:
          "Tunnistan roolit erilaisissa yhteisöissä ja vuorovaikutustilanteissa.",
      },
      {
        title:
          "Osallistun turvallisen ilmapiirin rakentamiseen yhdessä muun opiskelijayhteisön kanssa.",
      },
      {
