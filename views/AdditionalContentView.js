...
import { StyleSheet, Text, Linking, SafeAreaView, ScrollView, TouchableOpacity, StatusBar} from 'react-native';
      ...
      <SafeAreaView style={styles.container}>
        <ScrollView style={styles.scrollView}>
          <Text style={styles.title}>Muuta hyödyllistä sisältöä</Text>
            <TouchableOpacity style={styles.button} onPress={() => onPress('https://luovi.fi/opiskelen-luovissa/ruokalistat/')}>
            ...
            <TouchableOpacity style={styles.button} onPress={() => onPress('http://masto.luovi.fi/')}>
              <Text style={styles.buttonText}>Opiskelijaintra Masto</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => onPress('https://luovi.inschool.fi/')}>
              <Text style={styles.buttonText}>Wilma</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button} onPress={() => Linking.openURL('https://luovi.fi/tutustu-ja-hae-luoviin/tapahtumakalenteri/')}>
